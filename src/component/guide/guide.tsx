...
import { Steps, Card, Typography, Button } from "antd";
import {
  LoginOutlined,
  KeyOutlined,
  ApiOutlined,
...
export const Guide: React.FC<GuideProps> = ({handleStartStep}) => {
      ...
      content: {
        ...
        description: (
          <div className="space-y-2">
            <Paragraph>1. Acesse a página de login da Voltbras</Paragraph>
            <Paragraph>2. Insira seu email cadastrado</Paragraph>
            <Paragraph>3. Digite sua senha</Paragraph>
            <Paragraph>
              4. Clique no botão Entrar para acessar sua conta
            </Paragraph>
            <Paragraph className="text-blue-600">
              Este passo é essencial para garantir acesso seguro aos dados que
              serão migrados.
            </Paragraph>
          </div>
        ),
      ...
      content: {
        ...
        description: (
          <div className="space-y-2">
            ...
            <Paragraph>2. Insira o Client ID no campo indicado</Paragraph>
            <Paragraph>3. Clique no botão Autorizar Acesso</Paragraph>
            <Paragraph>
              4. Você será redirecionado para a página de autorização da Conta
              Azul
            </Paragraph>
            <Paragraph className="text-blue-600">
      ...
      content: {
        ...
        description: (
          <div className="space-y-2">
            ...
            <Paragraph>2. Confirme a autorização para a integração</Paragraph>
            <Paragraph>3. Aguarde o redirecionamento automático</Paragraph>
            <Paragraph className="text-blue-600">
              Este passo confirma sua identidade na Conta Azul e permite o
      ...
      content: {
        ...
        description: (
          <div className="space-y-2">
            ...
            <Paragraph>2. Escolha o tipo de execução:</Paragraph>
            ...
            <Paragraph className="text-blue-600">
              Você pode executar múltiplas migrações simultaneamente e
